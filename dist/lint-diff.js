...
(0, _lintDiff2.default)(cli.input[0], cli.flags.ext);
...
var _then2 = __webpack_require__(/*! ramda/src/then */ "ramda/src/then");
...
var _pipeWith2 = __webpack_require__(/*! ramda/src/pipeWith */ "ramda/src/pipeWith");

var _pipeWith3 = _interopRequireDefault(_pipeWith2);
...
var getChangedFileLineMap = (0, _curry3.default)(function (commitRange, filePath) {
  return (0, _pipeWith3.default)(_then3.default, [getDiff(commitRange), _git.getChangedLinesFromDiff, (0, _objOf3.default)('changedLines'), (0, _assoc3.default)('filePath', filePath)])(filePath);
});
...
var run = function run() {
  ...
  var extensions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '.js';
  return _bluebird2.default.resolve(commitRange).then(getChangedFiles(extensions)).map(getChangedFileLineMap(commitRange)).then(applyLinter).then(reportResults);
};
...
/***/ "ramda/src/pipeWith":
/*!*************************************!*\
  !*** external "ramda/src/pipeWith" ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("ramda/src/pipeWith");
...
/***/ "ramda/src/then":
/*!*********************************!*\
  !*** external "ramda/src/then" ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("ramda/src/then");
